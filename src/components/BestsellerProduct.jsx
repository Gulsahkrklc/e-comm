...
function BestsellerProducts({ history }) {
  const products = [
    {
      id: 1,
      ...
      <div className="space-y-6">
        {products.map((product) => (
          <div
            ...
            className="group bg-white rounded-lg overflow-hidden transition-shadow hover:shadow-md cursor-pointer"
          >
...
export default withRouter(BestsellerProducts);
